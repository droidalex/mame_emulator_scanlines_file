# This is a file to improve the gaming experience with the M.A.M.E. (Multiple Arcade Machine Emulator)

## Just create a mame.ini file (mame -createconfig) and write these lines on mame.ini:
```
  effect scanlines
```
